...
console.log(is31Flavors(fruitFlavors))
...
function addFlavor(newFlavor, flavorArray){
...
function removeFlavorByName(flavorArray, flavor){
    ...
    let index = flavorArray.indexOf(flavor) 
    if (index > -1) {
...
function filterByWord(flavorArray, flavorString){

    let filteredArray = []

    for (i = 0; i < flavorArray.length; i++) {
       if (flavorArray[i].includes(flavorString)) {
...
console.log("Filter By:", filterByWord(originalFlavors, "Chocolate"));
